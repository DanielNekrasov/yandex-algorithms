/**
 ...
 Удаляемый узел может иметь 0 – 3 ребра. (Имеется в виду связи от и от родителя и до потомков). Соответственно при его удалении дерево может распасться на 0 - 3 отдельных дерева.
 ...
 Общая временная сложность удаления узла – O(h). При сбалансированном дереве h ~ log n. При несбалансированном, в худшем случае h = n
